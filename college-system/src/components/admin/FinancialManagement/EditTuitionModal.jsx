...
export default function EditTuitionModal({ isOpen, onClose, onSubmit, tuition }) {
    ...
    useEffect(() => {
        if (tuition) {
            setFormData({
                ...
                fee: tuition.fee.replace('$', '').replace(',', '')
            });
        }
    }, [tuition]);
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold text-gray-900">Edit Tuition Rate</h2>
                            <button
                                type="button"
                                onClick={onClose}
