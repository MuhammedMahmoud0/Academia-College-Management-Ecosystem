        ...
        <div className="p-5">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-gray-500 uppercase w-20">Code</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-gray-500 uppercase w-20">Dept</span>
              <span className="text-sm text-gray-800">{course.department}</span>
            </div>
          </div>
          <p className="text-xs text-amber-600 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mt-4">
            <strong>Note:</strong> Courses that are prerequisites for other courses cannot be deleted.
          </p>
        </div>
