...
export default function AddLectureModal({ isOpen, onClose, onSave, editingLecture }) {
  ...
  const handleSubmit = () => {
    if (!formData.offeringId || !formData.instructorId || !formData.capacity || 
