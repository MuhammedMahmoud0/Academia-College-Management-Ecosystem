import { 
  Description, Download, Edit, Delete, Visibility,
    ...
    <div className="bg-white rounded-xl p-5 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300 border border-gray-100 group">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex gap-1">
          <button 
            onClick={onEdit}
            className="p-2 hover:bg-indigo-50 text-indigo-600 rounded-lg transition-all hover:scale-110"
            disabled={isLoading}
            title="Edit"
          >
          ...
          <button 
            onClick={onDelete}
            className="p-2 hover:bg-red-50 text-red-600 rounded-lg transition-all hover:scale-110"
            disabled={isLoading}
            title="Delete"
          >
