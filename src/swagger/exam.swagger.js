    ...
    paths: {
        "/exams/all": {
            get: {
                ...
                responses: {
                    ...
                    403: {
                        description:
                            "Forbidden - Only admins and super admins can access",
                    },
                    500: {
                                ...
                                schema: {
                                    ...
                                    properties: {
                                        ...
                                        count: {
                                            type: "integer",
                                            description:
                                                "Number of active course offerings",
                                            example: 10,
                                        },
                                        data: {
                                            type: "array",
                                            items: {
                                                ...
                                                properties: {
                                                    ...
                                                    exams_count: {
                                                        type: "integer",
                                                        description:
                                                            "Number of exams already scheduled",
                                                    },
                                                },
                                            },
                                        },
        ...
        "/exams/set/{exam_id}": {
            ...
            delete: {
                ...
                description:
                    "Delete an exam from the system (Admin/Super Admin only)",
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        in: "path",
