                ...
                schema: {
                  ...
                  properties: {
                    ...
                    details: {
                      type: "object",
                      properties: {
                        lectures: { type: "integer", example: 2 },
                        tutorials_labs: { type: "integer", example: 1 },
                        exams: { type: "integer", example: 1 },
                      },
                    },
                  },
                },
  ...
  schemas: {
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              semester: {
                type: "string",
                description: "Semester for the offering",
                example: "Fall 2024",
              },
              lectures_count: {
                type: "integer",
    ...
    CourseOfferingUpdateRequest: {
      ...
      properties: {
        semester: {
          type: "string",
          description: "New semester for the offering",
          example: "Spring 2025",
        },
      },
    },
