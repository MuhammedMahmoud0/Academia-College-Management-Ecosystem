...
async function main() {
  ...
  const offer1 = await prisma.course_offerings.create({
    data: { course_code: cs101.code, semester: "Fall", year: 2025 },
  });
  const offer2 = await prisma.course_offerings.create({
    data: { course_code: cs201.code, semester: "Fall", year: 2025 },
  });
  const offer3 = await prisma.course_offerings.create({
    data: { course_code: math101.code, semester: "Fall", year: 2025 },
  });
